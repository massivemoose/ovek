...
func newProdTestHandler(t *testing.T) (http.Handler, *sql.DB) {
	...
	handler := newHandlerWithRegistryStore(config{
		...
		DataDir:  dataDir,
	}, db, noopEnqueuer{}, noopProjectCleaner{}, noopProjectRuntimeService{}, managedProjectPocketBaseService{}, passthroughWorkflowImageResolver{}, nil, newRegistryCredentialStore(db, cipherBox))
